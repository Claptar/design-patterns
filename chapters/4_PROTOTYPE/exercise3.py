...
class Dashboard:
    ...
    def clone(self, **changes) -> "Dashboard":
        """Return a cloned dashboard using custom copy/share/reset rules."""
        # TODO:
        # Create a new Dashboard where:
        # - widgets are deep-copied
        # - filters are deep-copied
        # - data_source is shared with the original
        # - cache starts empty
        # - keyword changes are applied
