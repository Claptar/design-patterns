...
class DashboardPrototypeFactoryTests(unittest.TestCase):
    ...
    def test_new_marketing_dashboard_uses_marketing_prototype(self):
        dashboard = DashboardFactory.new_marketing_dashboard(
            title="Germany Marketing Dashboard",
            owner="Bruno",
            region="Germany",
        )
