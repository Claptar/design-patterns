...
class SingletonMeta(type):
    ...
    def __call__(cls, *args, **kwargs):
        # TODO: This method replaces the normal type.__call__ path.
        # If cls is not in the cache, call super().__call__(*args, **kwargs)
        # and store the created object.
        # Then return the cached object.
        return super().__call__(*args, **kwargs)

    def reset_instance(cls):
        # TODO: Remove only this class from the cache.
        pass
